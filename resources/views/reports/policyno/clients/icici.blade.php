    ...
    <table class="table table-bordered border-primary">
        <tbody>
            ...
            <tr>
                ...
                <td>
                    <iframe src="{{asset('storage/'.$caseresponse->response) }}" name="caseresponses[{{$caseresponse->questions->questionid}}][response]" height="200px" width="100%" class="img_tag"></iframe>
                </td>
            </tr>
            @break
